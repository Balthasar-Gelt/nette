<?php
// source: C:\laragon\www\nette_zadanie/config/common.neon
// source: C:\laragon\www\nette_zadanie/config/services.neon
// source: array
...
class Container_6b816a2c89 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Repository\PetRepository' => [['02']],
		'App\Storage\XMLStorageManager' => [['03']],
		'App\Components\Pet\Form\Add\ComponentFactory' => [['04']],
		'App\Components\Pet\Form\Edit\ComponentFactory' => [['05']],
	...
	public function createService02(): App\Repository\PetRepository
	{
		return new App\Repository\PetRepository($this->getService('03'));
	}


	public function createService03(): App\Storage\XMLStorageManager
	{
		return new App\Storage\XMLStorageManager('C:\laragon\www\nette_zadanie\app/Data/pets.xml');
	}


	public function createService04(): App\Components\Pet\Form\Add\ComponentFactory
	{
		return new App\Components\Pet\Form\Add\ComponentFactory($this->getService('02'));
	}


	public function createService05(): App\Components\Pet\Form\Edit\ComponentFactory
	{
		return new App\Components\Pet\Form\Edit\ComponentFactory($this->getService('02'));
	}


	public function createService06(): App\Components\Pet\Grid\ComponentFactory
	{
		return new App\Components\Pet\Grid\ComponentFactory($this->getService('02'));
	}
	...
	public function createServiceApplication__3(): App\UI\Pet\PetPresenter
	{
		$service = new App\UI\Pet\PetPresenter(
			$this->getService('02'),
			$this->getService('04'),
			$this->getService('05'),
			$this->getService('06'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\laragon\www\nette_zadanie/temp/cache/nette.application/touch',
		));
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_6b816a2c89 $container,
			) {
			}
