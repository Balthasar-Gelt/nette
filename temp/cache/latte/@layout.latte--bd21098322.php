...
/** source: C:\laragon\www\nette_zadanie\app\UI/@layout.latte */
final class Template_bd21098322 extends Latte\Runtime\Template
{
...
';
    ...
    <header>
        ...
        <nav>
            <ul>
                <li><a href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Pet:list', ['status' => 'all'])) /* line 17 */;
		echo '">List Pets</a></li>
            </ul>
        </nav>
    </header>
